...
public class InitialBoardReduced extends JFrame{
    private boolean iconSelected;
    private JButton selectedButton;
    private int selectedButtoni,selectedButtonj;
    String Rb;
    private square[][] boardR= new square[3][10];

    public square[][] getBoardR() {
        return boardR;
    }

    public InitialBoardReduced(player p) {
        ...
        boardR[0][3]=new square();
        boardR[0][4]=new square();
        boardR[0][5]=new square();
    ...
    private ImageIcon getImageHidden(){
        try {
